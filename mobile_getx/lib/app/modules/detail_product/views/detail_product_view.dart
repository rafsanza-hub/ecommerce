...
import 'package:mobile_getx/app/modules/detail_product/controllers/detail_product_controller.dart';
import 'package:mobile_getx/app/core/helpers/helpers/extensions/extensions.dart';
...
class DetailProductView extends StatefulWidget {
  ...
  @override
  DetailProductViewState createState() => DetailProductViewState();
}

class DetailProductViewState extends State<DetailProductView>
  ...
  void initState() {
    ...
    controller = DetailProductController(this, widget.product);
  }
        ...
        children: [
          Hero(
            ...
            child: MyContainer(
              ...
              child: Image(
                fit: BoxFit.cover,
                image: AssetImage(controller.product.image.toString()),
              ),
            ),
          ),
          MySpacing.height(20),
